...
/**
 * this class is for the bullet of my main character
 */
public class Shoot extends DynamicBody{
    ...
    /**
     * intialises the shooting of the main character
     * @param world
     * @param main
     */
    public Shoot(World world, Goku main) {
        super(world, shape);
        addImage(image);
        this.setGravityScale(0.0f);
        this.setLinearVelocity(new Vec2(main.facing * 15f, 0));
        this.addCollisionListener(new ShotHit(this));
    }
